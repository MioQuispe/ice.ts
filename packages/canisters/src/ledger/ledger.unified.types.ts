...
import { ArchiveOptions, Duration, ICPTs } from "./ledger.private.types"
...
export interface LedgerCanisterInitPayload {
  ...
  'minting_account' : AccountIdentifierString,
  'transaction_window' : [] | [Duration],
  'max_message_size_bytes' : [] | [bigint],
  'archive_options' : [] | [ArchiveOptions],
  'initial_values' : Array<[AccountIdentifierString, ICPTs]>,
}
