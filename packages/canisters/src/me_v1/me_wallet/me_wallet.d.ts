...
export interface _SERVICE {
  ...
  'id_anchor_get' : (arg_0: string) => Promise<Array<string>>,
  'job_data_export' : (
      arg_0: string,
      arg_1: bigint,
      arg_2: bigint,
  ...
  'wallet_me_add' : (
      arg_0: string,
      arg_1: string,
      arg_2: MEAccountDetails,
    ) => Promise<Result_12>,
  'wallet_me_get' : (arg_0: string) => Promise<
      Array<[Principal, MEAccountDetails]>
    >,
  'wallet_me_remove' : (
      arg_0: string,
      arg_1: string,
  ...
  'wallet_nns_add' : (
      arg_0: string,
      arg_1: string,
      arg_2: NNSAccountDetails,
    ) => Promise<Result_12>,
  'wallet_nns_get' : (arg_0: string) => Promise<
      Array<[string, NNSAccountDetails]>
    >,
  'wallet_nns_remove' : (
      arg_0: string,
      arg_1: string,
